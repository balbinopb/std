...
int main() {
    ...
    address P1 = createElemQueue("John Doe", 65, "lansia", 1);
    address P2 = createElemQueue("Alice", 30, "tenaga kesehatan", 2);
    address P3 = createElemQueue("Bob", 25, "pekerja", 3);
    address P4 = createElemQueue("Charlie", 70, "pensiunan", 4);
    address P5 = createElemQueue("David", 28, "pekerja", 5);
    ...
    address P6 = createElemQueue("Edward", 22, "pekerja", 6);
    enqueue(Q, P6);
    ...
    address removedElem = findAndRemove(Q, 3);
